...
class MYEX_HelloWorld extends ET_Builder_Module_Type_PostBased {
    ...
    /**
        ...
        function init() {
            $this->name             = esc_html__( 'PortfolioExtended', 'et_builder' );
            $this->plural           = esc_html__( 'PortfoliosExtended', 'et_builder' );
        ...
        function get_fields() {
            $fields = array(
                ...
                '__posts'                       => array(
                    'type'                => 'computed',
                    'computed_callback'   => array( 'MYEX_HelloWorld', 'get_blog_posts' ),
        ...
        function render_pagination( $echo = true ) {
            ...
            add_filter( 'get_pagenum_link', array( 'MYEX_HelloWorld', 'filter_pagination_url' ) );
            ...
            remove_filter( 'get_pagenum_link', array( 'MYEX_HelloWorld', 'filter_pagination_url' ) );
