...
class BA_Module_PortfolioExtended extends ET_Builder_Module_Type_PostBased {
	/**
	...
	function init() {
		$this->name             = esc_html__( 'Portfolio Extended', 'et_builder' );
		$this->plural           = esc_html__( 'Portfolios Extended', 'et_builder' );
		$this->slug             = 'et_pb_portfolio_extended';
		$this->vb_support       = 'on';
	...
	function get_fields() {
		$fields = array(
			...
			'__posts'                       => array(
				'type'                => 'computed',
				'computed_callback'   => array( 'BA_Module_PortfolioExtended', 'get_blog_posts' ),
	...
	function render_pagination( $echo = true ) {
		...
		add_filter( 'get_pagenum_link', array( 'BA_Module_PortfolioExtended', 'filter_pagination_url' ) );
		...
		remove_filter( 'get_pagenum_link', array( 'BA_Module_PortfolioExtended', 'filter_pagination_url' ) );
...
new BA_Module_PortfolioExtended();
